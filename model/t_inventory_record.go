...
type InventoryRecord struct {
	Base
	SelfBuiltId  int     `gorm:"index:taskIdSkuUserName;type:int(11);comment:自建盘点任务ID"`
	Sku          string  `gorm:"index:taskIdSkuUserName;type:varchar(64);comment:sku"`
	UserName     string  `gorm:"index:taskIdSkuUserName;type:varchar(16);not null;comment:盘点人"`
